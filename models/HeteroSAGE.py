...
#                         conv[edge_type_str] = SAGEconv(hidden_channels)
#             else:
#                 for edge_type in edge_types:
#                     edge_type_str = '_'.join(edge_type)
#                     conv[edge_type_str] = SAGEconv(hidden_channels)
...
#                     out_dict[dst_type].append(conv[edge_type_str]((h_dict[src_type], h_dict[dst_type]), adj_t_dict_mean[edge_type]))
